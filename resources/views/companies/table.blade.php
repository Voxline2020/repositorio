	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="row p-0 m-0">
				...
				<div class="col-lg-6 py-1 px-1">
						<a href="#" class="btn btn-warning w-100">Eventos</a>
				</div>
				{{-- <div class="col-lg-6 py-1 px-1">
...
<div class="col-md-4 p-1">
	<div class="card h-100 ">
		<a href="{!! route('companies.create') !!}"  class="btn btn-success w-100 h-100 d-flex justify-content-center align-items-center font-weight-bolder" style="font-size:3rem">+</a>
	</div>
</div>
