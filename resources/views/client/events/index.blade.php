...
<div class="container">
	<div class="row">
		...
		@if($old_check==0)
			<div class="col-md-2">
				<a class="btn btn-outline-secondary w-100" href="{!! route('clients.events.view_old') !!}">Ver Antiguos</a>
			</div>
		@else
			<div class="col-md-2">
				<a class="btn btn-outline-secondary w-100" href="{!! route('clients.events.index') !!}">Ocultar Antiguos</a>
			</div>
		@endif
		<div class="col-md-2">
